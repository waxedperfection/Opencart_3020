...
class ControllerExtensionPaymentFirstdataRemote extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['payment_firstdata_remote_merchant_id'])) {
			$data['firstdata_remote_merchant_id'] = $this->request->post['payment_firstdata_remote_merchant_id'];
		} else {
			$data['firstdata_remote_merchant_id'] = $this->config->get('payment_firstdata_remote_merchant_id');
		}

		if (isset($this->request->post['payment_firstdata_remote_user_id'])) {
			$data['firstdata_remote_user_id'] = $this->request->post['payment_firstdata_remote_user_id'];
		} else {
			$data['firstdata_remote_user_id'] = $this->config->get('payment_firstdata_remote_user_id');
		}

		if (isset($this->request->post['payment_firstdata_remote_password'])) {
			$data['firstdata_remote_password'] = $this->request->post['payment_firstdata_remote_password'];
		} else {
			$data['firstdata_remote_password'] = $this->config->get('payment_firstdata_remote_password');
		}

		if (isset($this->request->post['payment_firstdata_remote_certificate'])) {
			$data['firstdata_remote_certificate'] = $this->request->post['payment_firstdata_remote_certificate'];
		} else {
			$data['firstdata_remote_certificate'] = $this->config->get('payment_firstdata_remote_certificate');
		}

		if (isset($this->request->post['payment_firstdata_remote_key'])) {
			$data['firstdata_remote_key'] = $this->request->post['payment_firstdata_remote_key'];
		} else {
			$data['firstdata_remote_key'] = $this->config->get('payment_firstdata_remote_key');
		}

		if (isset($this->request->post['payment_firstdata_remote_key_pw'])) {
			$data['firstdata_remote_key_pw'] = $this->request->post['payment_firstdata_remote_key_pw'];
		} else {
			$data['firstdata_remote_key_pw'] = $this->config->get('payment_firstdata_remote_key_pw');
		}

		if (isset($this->request->post['payment_firstdata_remote_ca'])) {
			$data['firstdata_remote_ca'] = $this->request->post['payment_firstdata_remote_ca'];
		} else {
			$data['firstdata_remote_ca'] = $this->config->get('payment_firstdata_remote_ca');
		}

		if (isset($this->request->post['payment_firstdata_remote_geo_zone_id'])) {
			$data['firstdata_remote_geo_zone_id'] = $this->request->post['payment_firstdata_remote_geo_zone_id'];
		} else {
			$data['firstdata_remote_geo_zone_id'] = $this->config->get('payment_firstdata_remote_geo_zone_id');
		}

		if (isset($this->request->post['payment_firstdata_remote_total'])) {
			$data['firstdata_remote_total'] = $this->request->post['payment_firstdata_remote_total'];
		} else {
			$data['firstdata_remote_total'] = $this->config->get('payment_firstdata_remote_total');
		}

		if (isset($this->request->post['payment_firstdata_remote_sort_order'])) {
			$data['firstdata_remote_sort_order'] = $this->request->post['payment_firstdata_remote_sort_order'];
		} else {
			$data['firstdata_remote_sort_order'] = $this->config->get('payment_firstdata_remote_sort_order');
		}

		if (isset($this->request->post['payment_firstdata_remote_status'])) {
			$data['firstdata_remote_status'] = $this->request->post['payment_firstdata_remote_status'];
		} else {
			$data['firstdata_remote_status'] = $this->config->get('payment_firstdata_remote_status');
		}

		if (isset($this->request->post['payment_firstdata_remote_debug'])) {
			$data['firstdata_remote_debug'] = $this->request->post['payment_firstdata_remote_debug'];
		} else {
			$data['firstdata_remote_debug'] = $this->config->get('payment_firstdata_remote_debug');
		}
		if (isset($this->request->post['payment_firstdata_remote_auto_settle'])) {
			$data['firstdata_remote_auto_settle'] = $this->request->post['payment_firstdata_remote_auto_settle'];
		} elseif (!isset($this->request->post['payment_firstdata_auto_settle']) && $this->config->get('payment_firstdata_remote_auto_settle') != '') {
			$data['firstdata_remote_auto_settle'] = $this->config->get('payment_firstdata_remote_auto_settle');
		} else {
			$data['firstdata_remote_auto_settle'] = 1;
		}

		if (isset($this->request->post['payment_firstdata_remote_3d'])) {
			$data['firstdata_remote_3d'] = $this->request->post['payment_firstdata_remote_3d'];
		} else {
			$data['firstdata_remote_3d'] = $this->config->get('payment_firstdata_remote_3d');
		}

		if (isset($this->request->post['payment_firstdata_remote_liability'])) {
			$data['firstdata_remote_liability'] = $this->request->post['payment_firstdata_remote_liability'];
		} else {
			$data['firstdata_remote_liability'] = $this->config->get('payment_firstdata_remote_liability');
		}

		if (isset($this->request->post['payment_firstdata_remote_order_status_success_settled_id'])) {
			$data['firstdata_remote_order_status_success_settled_id'] = $this->request->post['payment_firstdata_remote_order_status_success_settled_id'];
		} else {
			$data['firstdata_remote_order_status_success_settled_id'] = $this->config->get('payment_firstdata_remote_order_status_success_settled_id');
		}

		if (isset($this->request->post['payment_firstdata_remote_order_status_success_unsettled_id'])) {
			$data['firstdata_remote_order_status_success_unsettled_id'] = $this->request->post['payment_firstdata_remote_order_status_success_unsettled_id'];
		} else {
			$data['firstdata_remote_order_status_success_unsettled_id'] = $this->config->get('payment_firstdata_remote_order_status_success_unsettled_id');
		}

		if (isset($this->request->post['payment_firstdata_remote_order_status_decline_id'])) {
			$data['firstdata_remote_order_status_decline_id'] = $this->request->post['payment_firstdata_remote_order_status_decline_id'];
		} else {
			$data['firstdata_remote_order_status_decline_id'] = $this->config->get('payment_firstdata_remote_order_status_decline_id');
		}

		if (isset($this->request->post['payment_firstdata_remote_order_status_void_id'])) {
			$data['firstdata_remote_order_status_void_id'] = $this->request->post['payment_firstdata_remote_order_status_void_id'];
		} else {
			$data['firstdata_remote_order_status_void_id'] = $this->config->get('payment_firstdata_remote_order_status_void_id');
		}

		if (isset($this->request->post['payment_firstdata_remote_order_status_refunded_id'])) {
			$data['firstdata_remote_order_status_refunded_id'] = $this->request->post['payment_firstdata_remote_order_status_refunded_id'];
		} else {
			$data['firstdata_remote_order_status_refunded_id'] = $this->config->get('payment_firstdata_remote_order_status_refunded_id');
		}

		if (isset($this->request->post['payment_firstdata_remote_card_storage'])) {
			$data['firstdata_remote_card_storage'] = $this->request->post['payment_firstdata_remote_card_storage'];
		} else {
			$data['firstdata_remote_card_storage'] = $this->config->get('payment_firstdata_remote_card_storage');
		}
		...
		if (isset($this->request->post['payment_firstdata_remote_cards_accepted'])) {
			$data['firstdata_remote_cards_accepted'] = $this->request->post['payment_firstdata_remote_cards_accepted'];
		} elseif ($this->config->get('payment_firstdata_remote_cards_accepted')) {
			$data['firstdata_remote_cards_accepted'] = $this->config->get('payment_firstdata_remote_cards_accepted');
		} else {

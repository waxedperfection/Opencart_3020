...
class ControllerExtensionPaymentKlarnaCheckout extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['payment_klarna_checkout_debug'])) {
			$data['klarna_checkout_debug'] = $this->request->post['payment_klarna_checkout_debug'];
		} else {
			$data['klarna_checkout_debug'] = $this->config->get('payment_klarna_checkout_debug');
		}

		if (isset($this->request->post['payment_klarna_checkout_colour_button'])) {
			$data['klarna_checkout_colour_button'] = $this->request->post['payment_klarna_checkout_colour_button'];
		} elseif ($this->config->get('payment_klarna_checkout_colour_button')) {
			$data['klarna_checkout_colour_button'] = $this->config->get('payment_klarna_checkout_colour_button');
		} else {
			$data['klarna_checkout_colour_button'] = '#0072cc';
		}

		if (isset($this->request->post['payment_klarna_checkout_colour_button_text'])) {
			$data['klarna_checkout_colour_button_text'] = $this->request->post['payment_klarna_checkout_colour_button_text'];
		} elseif ($this->config->get('payment_klarna_checkout_colour_button_text')) {
			$data['klarna_checkout_colour_button_text'] = $this->config->get('payment_klarna_checkout_colour_button_text');
		} else {
			$data['klarna_checkout_colour_button_text'] = '#ffffff';
		}

		if (isset($this->request->post['payment_klarna_checkout_colour_checkbox'])) {
			$data['klarna_checkout_colour_checkbox'] = $this->request->post['payment_klarna_checkout_colour_checkbox'];
		} elseif ($this->config->get('payment_klarna_checkout_colour_checkbox')) {
			$data['klarna_checkout_colour_checkbox'] = $this->config->get('payment_klarna_checkout_colour_checkbox');
		} else {
			$data['klarna_checkout_colour_checkbox'] = '#0072cc';
		}

		if (isset($this->request->post['payment_klarna_checkout_colour_checkbox_checkmark'])) {
			$data['klarna_checkout_colour_checkbox_checkmark'] = $this->request->post['payment_klarna_checkout_colour_checkbox_checkmark'];
		} elseif ($this->config->get('payment_klarna_checkout_colour_checkbox_checkmark')) {
			$data['klarna_checkout_colour_checkbox_checkmark'] = $this->config->get('payment_klarna_checkout_colour_checkbox_checkmark');
		} else {
			$data['klarna_checkout_colour_checkbox_checkmark'] = '#ffffff';
		}

		if (isset($this->request->post['payment_klarna_checkout_colour_header'])) {
			$data['klarna_checkout_colour_header'] = $this->request->post['payment_klarna_checkout_colour_header'];
		} elseif ($this->config->get('payment_klarna_checkout_colour_header')) {
			$data['klarna_checkout_colour_header'] = $this->config->get('payment_klarna_checkout_colour_header');
		} else {
			$data['klarna_checkout_colour_header'] = '#434343';
		}

		if (isset($this->request->post['payment_klarna_checkout_colour_link'])) {
			$data['klarna_checkout_colour_link'] = $this->request->post['payment_klarna_checkout_colour_link'];
		} elseif ($this->config->get('payment_klarna_checkout_colour_link')) {
			$data['klarna_checkout_colour_link'] = $this->config->get('payment_klarna_checkout_colour_link');
		} else {
			$data['klarna_checkout_colour_link'] = '#0072cc';
		}

		if (isset($this->request->post['payment_klarna_checkout_separate_shipping_address'])) {
			$data['klarna_checkout_separate_shipping_address'] = $this->request->post['payment_klarna_checkout_separate_shipping_address'];
		} else {
			$data['klarna_checkout_separate_shipping_address'] = $this->config->get('payment_klarna_checkout_separate_shipping_address');
		}

		if (isset($this->request->post['payment_klarna_checkout_dob_mandatory'])) {
			$data['klarna_checkout_dob_mandatory'] = $this->request->post['payment_klarna_checkout_dob_mandatory'];
		} else {
			$data['klarna_checkout_dob_mandatory'] = $this->config->get('payment_klarna_checkout_dob_mandatory');
		}

		if (isset($this->request->post['payment_klarna_checkout_title_mandatory'])) {
			$data['klarna_checkout_title_mandatory'] = $this->request->post['payment_klarna_checkout_title_mandatory'];
		} else {
			$data['klarna_checkout_title_mandatory'] = $this->config->get('payment_klarna_checkout_title_mandatory');
		}

		if (isset($this->request->post['payment_klarna_checkout_additional_text_box'])) {
			$data['klarna_checkout_additional_text_box'] = $this->request->post['payment_klarna_checkout_additional_text_box'];
		} else {
			$data['klarna_checkout_additional_text_box'] = $this->config->get('payment_klarna_checkout_additional_text_box');
		}

		if (isset($this->request->post['payment_klarna_checkout_total'])) {
			$data['klarna_checkout_total'] = $this->request->post['payment_klarna_checkout_total'];
		} else {
			$data['klarna_checkout_total'] = $this->config->get('payment_klarna_checkout_total');
		}

		if (isset($this->request->post['payment_klarna_checkout_order_status_authorised_id'])) {
			$data['klarna_checkout_order_status_authorised_id'] = $this->request->post['payment_klarna_checkout_order_status_authorised_id'];
		} else {
			$data['klarna_checkout_order_status_authorised_id'] = $this->config->get('payment_klarna_checkout_order_status_authorised_id');
		}

		if (isset($this->request->post['payment_klarna_checkout_order_status_part_captured_id'])) {
			$data['klarna_checkout_order_status_part_captured_id'] = $this->request->post['payment_klarna_checkout_order_status_part_captured_id'];
		} else {
			$data['klarna_checkout_order_status_part_captured_id'] = $this->config->get('payment_klarna_checkout_order_status_part_captured_id');
		}

		if (isset($this->request->post['payment_klarna_checkout_order_status_captured_id'])) {
			$data['klarna_checkout_order_status_captured_id'] = $this->request->post['payment_klarna_checkout_order_status_captured_id'];
		} else {
			$data['klarna_checkout_order_status_captured_id'] = $this->config->get('payment_klarna_checkout_order_status_captured_id');
		}

		if (isset($this->request->post['payment_klarna_checkout_order_status_cancelled_id'])) {
			$data['klarna_checkout_order_status_cancelled_id'] = $this->request->post['payment_klarna_checkout_order_status_cancelled_id'];
		} else {
			$data['klarna_checkout_order_status_cancelled_id'] = $this->config->get('payment_klarna_checkout_order_status_cancelled_id');
		}

		if (isset($this->request->post['payment_klarna_checkout_order_status_refund_id'])) {
			$data['klarna_checkout_order_status_refund_id'] = $this->request->post['payment_klarna_checkout_order_status_refund_id'];
		} else {
			$data['klarna_checkout_order_status_refund_id'] = $this->config->get('payment_klarna_checkout_order_status_refund_id');
		}

		if (isset($this->request->post['payment_klarna_checkout_order_status_fraud_rejected_id'])) {
			$data['klarna_checkout_order_status_fraud_rejected_id'] = $this->request->post['payment_klarna_checkout_order_status_fraud_rejected_id'];
		} else {
			$data['klarna_checkout_order_status_fraud_rejected_id'] = $this->config->get('payment_klarna_checkout_order_status_fraud_rejected_id');
		}

		if (isset($this->request->post['payment_klarna_checkout_order_status_fraud_pending_id'])) {
			$data['klarna_checkout_order_status_fraud_pending_id'] = $this->request->post['payment_klarna_checkout_order_status_fraud_pending_id'];
		} else {
			$data['klarna_checkout_order_status_fraud_pending_id'] = $this->config->get('payment_klarna_checkout_order_status_fraud_pending_id');
		}

		if (isset($this->request->post['payment_klarna_checkout_order_status_fraud_accepted_id'])) {
			$data['klarna_checkout_order_status_fraud_accepted_id'] = $this->request->post['payment_klarna_checkout_order_status_fraud_accepted_id'];
		} else {
			$data['klarna_checkout_order_status_fraud_accepted_id'] = $this->config->get('payment_klarna_checkout_order_status_fraud_accepted_id');
		}

		if (isset($this->request->post['payment_klarna_checkout_terms'])) {
			$data['klarna_checkout_terms'] = $this->request->post['payment_klarna_checkout_terms'];
		} else {
			$data['klarna_checkout_terms'] = $this->config->get('payment_klarna_checkout_terms');
		}

		if (isset($this->request->post['payment_klarna_checkout_status'])) {
			$data['klarna_checkout_status'] = $this->request->post['payment_klarna_checkout_status'];
		} else {
			$data['klarna_checkout_status'] = $this->config->get('payment_klarna_checkout_status');
		}
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST' && !isset($this->request->post['payment_klarna_checkout_account'])) {
			...
			$data['klarna_checkout_account'] = $this->request->post['payment_klarna_checkout_account'];
		} elseif ($this->config->get('payment_klarna_checkout_account')) {
			$data['klarna_checkout_account'] = $this->config->get('payment_klarna_checkout_account');
		} else {
			$data['klarna_checkout_account'] = array();
		}

		if (isset($this->request->post['payment_klarna_checkout_sftp_username'])) {
			$data['klarna_checkout_sftp_username'] = $this->request->post['payment_klarna_checkout_sftp_username'];
		} else {
			$data['klarna_checkout_sftp_username'] = $this->config->get('payment_klarna_checkout_sftp_username');
		}

		if (isset($this->request->post['payment_klarna_checkout_sftp_password'])) {
			$data['klarna_checkout_sftp_password'] = $this->request->post['payment_klarna_checkout_sftp_password'];
		} else {
			$data['klarna_checkout_sftp_password'] = $this->config->get('payment_klarna_checkout_sftp_password');
		}

		if (isset($this->request->post['payment_klarna_checkout_settlement_order_status_id'])) {
			$data['klarna_checkout_settlement_order_status_id'] = $this->request->post['payment_klarna_checkout_settlement_order_status_id'];
		} else {
			$data['klarna_checkout_settlement_order_status_id'] = $this->config->get('payment_klarna_checkout_settlement_order_status_id');
		}

...
class ControllerExtensionPaymentPayPoint extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['payment_paypoint_geo_zone_id'])) {
			$data['paypoint_geo_zone_id'] = $this->request->post['payment_paypoint_geo_zone_id'];
		} else {
			$data['paypoint_geo_zone_id'] = $this->config->get('payment_paypoint_geo_zone_id');
		}
		...
		if (isset($this->request->post['payment_paypoint_status'])) {
			$data['paypoint_status'] = $this->request->post['payment_paypoint_status'];
		} else {
			$data['paypoint_status'] = $this->config->get('payment_paypoint_status');
		}

		if (isset($this->request->post['payment_paypoint_sort_order'])) {
			$data['paypoint_sort_order'] = $this->request->post['payment_paypoint_sort_order'];
		} else {
			$data['paypoint_sort_order'] = $this->config->get('payment_paypoint_sort_order');
		}
